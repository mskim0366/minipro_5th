            ...
            <div class="table-responsive">
                <v-table>
                    <thead>
                        ...
                        <th>CreatedAt</th>
                        <th>UpdatedAt</th>
                        <th>IsBookPublished</th>
                        <th>Price</th>
                        <th>BookCover</th>
                        <th>Summary</th>
                        <th>BookReleaseAdminId</th>
                        <th>AuthorId</th>
                        <th>IsBestseller</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="IsBookPublished">{{ val.isBookPublished }}</td>
                            <td class="whitespace-nowrap" label="Price">{{ val.price }}</td>
                            <td class="whitespace-nowrap" label="Summary">{{ val.summary }}</td>
                            <td class="whitespace-nowrap" label="BookReleaseAdminId">{{ val.bookReleaseAdminId }}</td>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <Boolean label="IsBookPublished" v-model="selectedRow.isBookPublished" :editMode="true"/>
                            <Number label="Price" v-model="selectedRow.price" :editMode="true"/>
                            <String label="Summary" v-model="selectedRow.summary" :editMode="true"/>
                            <Number label="BookReleaseAdminId" v-model="selectedRow.bookReleaseAdminId" :editMode="true"/>
                            ...
                            <File offline label="BookCover" v-model="selectedRow.bookCover" :editMode="true"/>
